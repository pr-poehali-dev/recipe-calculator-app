...
const CATEGORIES_MAP: Record<string, string[]> = {
  '🥚 Яйца и молочное': ['яйца', 'молоко', 'творог', 'сметана', 'кефир', 'сыр', 'масло сливочное', 'йогурт', 'сыр моцарелла', 'сыр пармезан', 'сливки', 'ряженка', 'простокваша'],
  '🥩 Мясо и птица': ['курица', 'куриное филе', 'куриные бёдра', 'куриные крылья', 'говядина', 'свинина', 'фарш говяжий', 'фарш свиной', 'фарш куриный', 'индейка', 'утка', 'кролик', 'бекон', 'сосиски', 'колбаса', 'ветчина'],
  '🐟 Рыба и морепродукты': ['рыба', 'лосось', 'тунец', 'треска', 'минтай', 'скумбрия', 'сельдь', 'креветки', 'кальмары', 'мидии', 'икра'],
  '🥔 Овощи': ['картофель', 'морковь', 'лук', 'чеснок', 'помидоры', 'огурцы', 'капуста', 'болгарский перец', 'баклажан', 'кабачок', 'брокколи', 'шпинат', 'салат', 'цветная капуста', 'лук-порей', 'сельдерей', 'свёкла', 'редис', 'пекинская капуста', 'зелёный горошек', 'кукуруза', 'спаржа', 'авокадо', 'тыква', 'патиссон', 'руккола', 'айсберг'],
  '🌾 Крупы и бобовые': ['рис', 'гречка', 'макароны', 'овсянка', 'геркулес', 'мука', 'булгур', 'киноа', 'пшено', 'перловка', 'манка', 'кускус', 'фасоль', 'горох', 'чечевица', 'нут', 'маш', 'соя'],
  '🍎 Фрукты': ['яблоки', 'бананы', 'апельсины', 'лимон', 'клубника', 'виноград', 'персики', 'груши', 'слива', 'вишня', 'черешня', 'манго', 'ананас', 'киви', 'гранат', 'дыня'],
  '🍓 Ягоды': ['малина', 'черника', 'голубика', 'ежевика', 'смородина'],
  '🍄 Грибы': ['грибы', 'шампиньоны', 'опята', 'белые грибы', 'лисички', 'вешенки'],
  '🫙 Консервы': ['консервированная кукуруза', 'консервированный горошек', 'консервированная фасоль', 'консервированные томаты', 'консервированные оливки', 'консервированный ананас'],
  '🥫 Соусы и маринады': ['томатная паста', 'майонез', 'горчица', 'соевый соус', 'уксус', 'кетчуп', 'аджика', 'хрен', 'ткемали', 'терияки', 'табаско', 'вустерский соус', 'рыбный соус', 'устричный соус'],
  '🌿 Специи и зелень': ['укроп', 'петрушка', 'базилик', 'тимьян', 'лавровый лист', 'соль', 'перец', 'кориандр', 'куркума', 'паприка', 'зира', 'карри', 'имбирь', 'орегано', 'розмарин', 'мята', 'эстрагон', 'шалфей', 'чили'],
  '🥜 Орехи и семена': ['грецкие орехи', 'миндаль', 'семена подсолнечника', 'кешью', 'фундук', 'арахис', 'кунжут', 'семена льна', 'тыквенные семечки'],
  '🍯 Сладкое': ['сахар', 'мёд', 'варенье', 'шоколад', 'какао', 'сахарная пудра', 'ванильный сахар', 'разрыхлитель', 'крахмал', 'желатин'],
  '🥖 Хлеб и выпечка': ['хлеб', 'тосты', 'батон', 'лаваш', 'слоёное тесто', 'дрожжевое тесто'],
  '🫒 Масла': ['масло растительное', 'масло оливковое', 'масло кокосовое'],
  '🍷 Напитки и бульоны': ['вино белое', 'вино красное', 'пиво', 'бульон куриный', 'бульон говяжий'],
};
